...
setupAsync({"server":{"url":"//api-maps.yandex.ru/2.1.56","path":"build/release","params":{"csp":null},"version":"2.1"},"preload":{"load":"package.full"},"enterprise":false,"key":undefined,"apikey":undefined,"browser":{"name":"Chrome","version":"63.0.3239.84","base":"Chromium","engine":"WebKit","engineVersion":"537.36","osName":"Windows 10","osFamily":"Windows","osVersion":"10.0","isMobile":false,"cssPrefix":"Webkit"},"lang":"ru_RU","languageCode":"ru","countryCode":"RU","hosts":{"api":{"main":"https://api-maps.yandex.ru/","ua":"https://yandex.ru/legal/maps_termsofuse/?lang={{lang}}","maps":"https://yandex.ru/maps/","statCounter":"https://yandex.ru/clck/","services":{"coverage":"https://api-maps.yandex.ru/services/coverage/","geocode":"https://geocode-maps.yandex.ru/","geoxml":"https://api-maps.yandex.ru/services/geoxml/","inception":"https://api-maps.yandex.ru/services/inception/","panoramaLocate":"https://api-maps.yandex.ru/services/panoramas/","search":"https://api-maps.yandex.ru/services/search/","suggest":"https://suggest-maps.yandex.ru/","regions":"https://api-maps.yandex.ru/services/regions/","route":"https://api-maps.yandex.ru/services/route/"}},"layers":{"map":"https://vec0%d.maps.yandex.net/tiles?l=map&%c&%l","sat":"https://sat0%d.maps.yandex.net/tiles?l=sat&%c&%l","skl":"https://vec0%d.maps.yandex.net/tiles?l=skl&%c&%l","stv":"https://0%d.srdr.maps.yandex.net/?l=stv&%c&v=%v&%l&action=render","sta":"https://lrs.maps.yandex.net/tiles?l=sta&%c&tm=%v&%l","staHotspot":"https://lrs.maps.yandex.net/tiles?l=stj&%c&tm=%v&%l","staHotspotKey":"%c&l=stj&tm=%v"},"traffic":"https://jgo.maps.yandex.net/","trafficArchive":"https://jft.maps.yandex.net/"},"layers":{"map":{"version":"17.12.12-3","scaled":true,"hotspotZoomRange":[13,23]},"sat":{"version":"3.361.0"},"skl":{"version":"17.12.12-3","scaled":true,"hotspotZoomRange":[13,23]},"trf":{"version":"1513334085","scaled":true},"sta":{"version":"0.28.1-0.1.3.1-0.2017.12.07.14.00.2.29.6-0.stable"},"stv":{"version":"3.84.0"}},"geolocation":{"longitude":37.67528,"latitude":47.955082,"isHighAccuracy":false,"span":{"longitude":2.550605,"latitude":2.548928}},"token":"f6fba7c44383277f88b3210c9b9cbfb6","sign":(function(r){function t(e){if(n[e])return n[e].exports;var o=n[e]={exports:{},id:e,loaded:!1};return r[e].call(o.exports,o,o.exports,t),o.loaded=!0,o.exports}var n={};return t.m=r,t.c=n,t.p="",t(0)})([function(r,t,n){"use strict";function e(){for(var r=["9","3","2","0","b","3","a","3","b","7","8","4","6","0","2","f","4","4","9","3","7","8","8","9","c","2","b","f","b","2","3","2","c","e","4","9","3","b","4","6"],t=[[(function(){var e=document.createElement("a");return e.href="http://anioj.io/?=6y%23",e.search.length})()+8,SVGPreserveAspectRatio.SVG_PRESERVEASPECTRATIO_XMINYMAX+2],[DOMException.NOT_FOUND_ERR+13,CSSRule.IMPORT_RULE+6],[(function(){try{var e=document.createElement("a");e.appendChild(e)}catch(t){return t.code}})()+30,(function(){try{var e=document,t=e.createRange(),a=e.createRange(),n=e.createElement("a");t.setStart(n,0),t.setEnd(n,0),t.compareBoundaryPoints(Range.START_TO_START,a)}catch(r){return r.code}})()+22]],n=0;n<t.length;n++){var e=t[n][0],o=t[n][1],i=r[e];r[e]=r[o],r[o]=i}return r.join("")}var o,i=n(1),u=n(2);r.exports=function(r){return o||(o=i(e())),i(u(r),o)}},function(r,t){"use strict";r.exports=function(r,t){t=t||0;for(var n=0;n<r.length;n++)t+=(t<<1)+(t<<4)+(t<<7)+(t<<8)+(t<<24),t^=r.charCodeAt(n);return t>>>0}},function(r,t){"use strict";r.exports=function(r){r=r.replace(/^.*\/\//,"");var t=r.indexOf("?");if(-1===t)return r;var n=t+1,e=r.indexOf("#",n);-1===e&&(e=r.length);var o=r.substring(n,e).split("&",1e3);return r.substring(0,n)+o.sort().join("&")+r.substring(e)}}]),"distribution":{},"version":"2.1.56","majorVersion":"2.1","cssPrefix":"ymaps-2-1-56-","coordinatesOrder":"latlong"})
})(this);
 //end of yandex api
(function($) {
  "use strict";
