...
?>
    ...
    <?/*Новинки*/?>
    <?
    global $arrNewProducts;
    $arrNewProducts = array("PROPERTY_".StockMan\Config::NEW_PRODUCT."_VALUE" => "да");
    ?>
    <?$APPLICATION->IncludeComponent(
        "bitrix:news.list",
        "newproducts",
        Array(
            ...
            "PARENT_SECTION_CODE" => "",
            "PREVIEW_TRUNCATE_LEN" => "",
            "PROPERTY_CODE" => array("NEWPRODUCT", StockMan\Config::BREND, ""),
            "SET_BROWSER_TITLE" => "Y",
            "SET_LAST_MODIFIED" => "N",
            "SET_META_DESCRIPTION" => "Y",
            "SET_META_KEYWORDS" => "Y",
