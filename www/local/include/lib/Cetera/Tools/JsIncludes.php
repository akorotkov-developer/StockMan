 ...
 *
 * 2. Зарегистрируем наши файлы в массиве \JsIncludes::$files с помощью функции JsIncludes::registerFile('common.common', '#COMMON_TEMPLATE_PATH#/js/common.js?v=1')
 ...
 * Значение - путь до файла. Поддерживаются "переменные": #COMMON_TEMPLATE_PATH# - трансформируется в путь до текущего шаблона.
 ...
 * 'common.jquery' => '#COMMON_TEMPLATE_PATH#/js/jquery.js?v=2.1.1',
 * 'common.common' => '#COMMON_TEMPLATE_PATH#/js/common.js?v=1',
 * 'catalog.catalog' => '#COMMON_TEMPLATE_PATH#/js/catalog/catalog.js?v=1',
 * 'catalog.order' => '#COMMON_TEMPLATE_PATH#/js/catalog/order/.js?v=1',
 * Почему не
 * 'catalog => '#COMMON_TEMPLATE_PATH#/js/catalog/catalog.js?v=1',
 * 'order' => '#COMMON_TEMPLATE_PATH#/js/catalog/order/.js?v=1',
...
class JsIncludes
{
    ...
    private static $files = array(
        'main.jq' => 'http://yandex.st/jquery/1.11.1/jquery.min.js'
    );

    private static $injectedVariables = array('#COMMON_TEMPLATE_PATH#' => COMMON_TEMPLATE_PATH);
     ...
     * @param $value '#COMMON_TEMPLATE_PATH#/js/common.js?v=1'
     */
