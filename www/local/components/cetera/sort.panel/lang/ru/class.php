...
$MESS['COMPONENT_SORT_PANEL_COMPONENT_SORT_TYPES_DATE_VALUE']       = 'по новинкам';
$MESS['COMPONENT_SORT_PANEL_COMPONENT_SORT_TYPES_PRICE_ASC']        = 'по возрастанию цены';
$MESS['COMPONENT_SORT_PANEL_COMPONENT_SORT_TYPES_PRICE_DESC']       = 'по убыванию цены';
$MESS['COMPONENT_SORT_PANEL_COMPONENT_SORT_TYPES_DISCOUNT']         = 'по скидкам';
$MESS['COMPONENT_SORT_PANEL_COMPONENT_VIEW_TYPES_MANN']             = 'На манекене';
$MESS['COMPONENT_SORT_PANEL_COMPONENT_VIEW_TYPES_MODEL']            = 'На модели';