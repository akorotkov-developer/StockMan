...
<div class="cell large-6">
    <form action="<?= POST_FORM_ACTION_URI?>" method="post" id="asd_subscribe_form">
        ...
        <input class="mail text-center" name="asd_email" type="email" value="" placeholder="укажите свой адрес электронной почты">

        <input type="submit" name="asd_submit" id="asd_subscribe_submit" value="<?=GetMessage("ASD_SUBSCRIBEQUICK_PODPISATQSA")?>" style="display: none;"/>
