...
<div class="profile-block-<?=strpos($arResult["opened"], "reg") === false ? "hidden" : "shown"?>" id="user_div_reg">
    ...
    <div class="grid-x grid-padding-x">
        <div class="cell">
            ...
            <label>
                <input type="text" name="TITLE" value='<?=$arResult["arUser"]["TITLE"]?>' placeholder='<?echo GetMessage("main_profile_title")?>'/>
            </label>

            <label>
                <input type="text" name="NAME" maxlength="50" value='<?=$arResult["arUser"]["NAME"]?>' placeholder='<?=$arResult["arUser"]["NAME"]?>'/>
            </label>

            <label>
                <input type="text" name="LAST_NAME" maxlength="50" value="<?=$arResult["arUser"]["LAST_NAME"]?>" placeholder='<?=$arResult["arUser"]["LAST_NAME"]?>'/>
            </label>
            ...
            <label>
                <input type="email" name="EMAIL" maxlength="50" value="<? echo $arResult["arUser"]["EMAIL"]?>" placeholder='<? echo $arResult["arUser"]["EMAIL"]?>'/>
            </label>

            <label>
                <input type="text" name="LOGIN" maxlength="50" value="<? echo $arResult["arUser"]["LOGIN"]?>" placeholder='<? echo $arResult["arUser"]["LOGIN"]?>'/>
            </label>
...
<table class="data-table profile-table">
	...
	<p><input type="submit" name="save" value="<?=(($arResult["ID"]>0) ? GetMessage("MAIN_SAVE") : GetMessage("MAIN_ADD"))?>" class="button">&nbsp;&nbsp;<input type="reset" class="button" value="<?=GetMessage('MAIN_RESET');?>"></p>
</form>
<?
