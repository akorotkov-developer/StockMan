...
if(strlen($arResult["ID"])>0)
{
    ...
    <div class="grid-x grid-padding-x ">
        ...
        <form method="post"  class="cell small-12 medium-4 large-12 xlarge-12 sale-profile-detail-form" action="<?=POST_FORM_ACTION_URI?>" enctype="multipart/form-data">
            <?=bitrix_sessid_post()?>
            ...
            <div class="form-group grid-x grid-padding-x">

                <label class="sale-personal-profile-detail-form-label cell small-12 medium-4 large-3 xlarge-3"><?=Loc::getMessage('SALE_PERS_TYPE')?></label>

                <div class="cell small-12 medium-4 large-9 xlarge-9">
                    <?=$arResult["PERSON_TYPE"]["NAME"]?>
                </div>
            </div>
            <div class="form-group grid-x grid-padding-x">
                <label class="sale-personal-profile-detail-form-label cell small-12 medium-4 large-3 xlarge-3" for="sale-personal-profile-detail-name">
            ...
            foreach($arResult["ORDER_PROPS"] as $block)
            {
                if (!empty($block["PROPS"]))
                {
                    ...
                    foreach($block["PROPS"] as $key => $property)
                    {
                        ...
                        ?>
                        <div class="form-group grid-x grid-padding-x sale-personal-profile-detail-property-<?=strtolower($property["TYPE"])?>">
                            <label class="sale-personal-profile-detail-form-label cell small-12 medium-4 large-3 xlarge-3 <?=$alignTop?>" for="sppd-property-<?=$key?>">
                                <?= $property["NAME"]?>:
                                <?
