...
?>
    ...
    <div class="cell small-12 medium-8 xlarge-10 large-9" >
        <div data-entity="<?=$containerName?>" class="grid-x text-center grid-padding-x small-up-1 medium-up-2 xlarge-up-5 large-up-3 margin-bottom-8" data-equalizer data-equalize-by-row="true">
