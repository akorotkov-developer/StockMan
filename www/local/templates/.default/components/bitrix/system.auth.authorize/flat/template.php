...
<?endforeach?>
		...
		<div class="bx-authform-formgroup-container">
			...
			<div class="bx-authform-input-container">
				<input type="text" name="USER_LOGIN" required maxlength="255" value="<?=$arResult["LAST_LOGIN"]?>" />
			</div>
		</div>
		<div class="bx-authform-formgroup-container">
...
<?endif?>
				<input type="password" required name="USER_PASSWORD" maxlength="255" autocomplete="off" />
			</div>
		</div>
...
<?endif?>
		<div class="bx-authform-formgroup-container">
			<input type="submit" class="btn btn-primary button expanded" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" />
		</div>
	</form>
