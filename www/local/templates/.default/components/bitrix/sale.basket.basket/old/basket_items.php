                                ...
                                <div class="grid-x grid-padding-x">
                                    ...
                                    <div class="cell medium-8">
                                        <?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?>
                                                <a class="text-insta text-uppercase text-decoration-none text-size-xlarge font-bold" href="<?=$arItem["DETAIL_PAGE_URL"] ?>">
                                        <?endif;?>
                                            <span class="text-insta text-uppercase text-decoration-none text-size-xlarge font-bold"><?=$arItem["NAME"]?></span>
                                            <?if (strlen($arItem["DETAIL_PAGE_URL"]) > 0):?>
                                        </a>
                                        <?endif;?>
                                        ...
                                        <ul class="hide-for-small-only hide-for-medium-only">
                                            ...
                                            if ($bPropsColumn):
                                                foreach ($arItem["PROPS"] as $val):
                                                    ...
                                                    echo "<li>".htmlspecialcharsbx($val["NAME"]).":&nbsp;".$val["VALUE"]."</li>";
                                                endforeach;
                                            endif;
                                            ?>
                                        </ul>
