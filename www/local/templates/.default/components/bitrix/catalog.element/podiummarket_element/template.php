...
?>
    <div class="skirt" id="<?=$itemIds['ID']?>">
        <div class="container-fluid">
            ...
            <div class="skirt__wrapper"  id="<?=$itemIds['BIG_SLIDER_ID']?>">
                ...
                ?>
                <div class="skirt__slider text-center"  data-entity="images-container">
                    <?
            ...
            if ($showSliderControls)
            {
                ...
                {
                    ?>
                    <div class="product-item-detail-slider-controls-block" id="<?=$itemIds['SLIDER_CONT_ID']?>" style="display:none">
                        <?
                        if (!empty($actualItem['MORE_PHOTO']))
                        {
                            foreach ($actualItem['MORE_PHOTO'] as $key => $photo)
            ...
            <div class="skirt__info">
                ...
                <div class="text-uppercase text-size-xsmall margin-bottom-3"><?=$arResult["PROPERTIES"][StockMan\Catalog\Config::CML2_ARTICLE]["VALUE"]?></div>
                        ...
                        switch ($blockName) {
                            case 'price':
                                ?>
                                    ...
                                    {
                                        ?>
                                        <div id="<?=$itemIds['DISCOUNT_PRICE_ID']?>"
                                             style="display: <?=($showDiscount ? '' : 'none')?>;">
                                            <?
                                            if ($showDiscount)
                                            {
                ...
                <div class="grid-x" id="<?=$itemIds['TAB_CONTAINERS_ID']?>">
                    <?
                                ...
                                ?>
                                    ...
                                    foreach ($arResult['DISPLAY_PROPERTIES'] as $property)
                                    {
                                        ...
                                        <div class="cell large-4 medium-4">
                                            <div class="small-12 medium-2 large-2 cell"><?=$property['NAME']?></div>
                                            <div class="checkbox-group">
                                                <input class="checkbox-group__item" type="radio" id="size1" name="size">
                                                <label class="checkbox-group__label" for="size1">
                                                    <?=(
                ...
                foreach ($arParams['PRODUCT_PAY_BLOCK_ORDER'] as $blockName)
                {
                    switch ($blockName)
                    {
                        case 'buttons':
                            ?>
                            <div class="grid-x grid-padding-x skirt__grid" data-entity="main-button-container">
                                <div id="<?=$itemIds['BASKET_ACTIONS_ID']?>" style="display: <?=($actualItem['CAN_BUY'] ? '' : 'none')?>;">
                                    ...
                                    if ($showAddBtn)
                                    {
                                        ...
                                        <div class="cell medium-6">
                                            <a class="button skirt__bag" href="javascript:void(0);" id="<?=$itemIds['ADD_BASKET_LINK']?>">
                                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Добавить в Корзину&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            </a>
                                        </div>
                                        <?
                                    ...
                                    if ($showBuyBtn)
                                    {
                                        ?>
                                        <div class="cell medium-6">
                                            <a class="button skirt__bag" href="javascript:void(0);" id="<?=$itemIds['BUY_LINK']?>">
                                ...
                                ?>
                                <div class="cell medium-6">
                                    <a class="button skirt__heart" href="javascript:void(0);" id="<?=$itemIds['NOT_AVAILABLE_MESS']?>">
                ...
                <ul class="accordion" data-accordion="">
                    <li class="accordion-item is-active" data-accordion-item=""><a class="accordion-title" href="#">Комментарий стилиста</a>
                                ...
                                foreach ($arParams['PRODUCT_INFO_BLOCK_ORDER'] as $blockName)
                                {
                                    switch ($blockName)
                                    {
                                        ...
                                        case 'props':
                                            ...
                                            {
                                                ?>
                                                <div class="product-item-detail-info-container dfhfghdfgh">
                                                    <?
                                                    if (!empty($arResult['DISPLAY_PROPERTIES']))
                                                    {
                                                        ?>
...
?>
    <script type="text/javascript">
        $( document ).ready(function() {
            ...
            $(".skirt").height($(".skirt__info").outerHeight()+120);
        });
    </script>
