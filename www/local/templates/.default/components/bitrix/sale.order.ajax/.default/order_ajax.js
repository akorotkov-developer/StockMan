...
(function() {
	...
	BX.Sale.OrderAjaxComponent = {
		...
		createBasketItemImg: function(data)
		{
			...
			logoNode = BX.create('DIV', {props: {className: 'bx-soa-item-imgcontainer margin-bottom-6'}});
                    ...
                    label = BX.create('DIV', {
                        ...
                        children: [
                            BX.create('INPUT', {
                                ...
                                props: {className: 'check__input', type: 'radio', name: 'PERSON_TYPE', value: currentType.ID, id: 'PERSON_TYPE_'+currentType.ID}
                            }),
                            BX.create('LABEL', {
                                props: {className: 'check__label'},
